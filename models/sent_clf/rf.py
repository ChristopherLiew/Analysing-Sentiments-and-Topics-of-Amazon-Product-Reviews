...
# a. Word2Vec
rf_w2v_optimal, rf_w2v_score, rf_w2v_params = tune_model(
    RandomForestClassifier(),
    (w2v_train_data, train_data.sentiment),
    search_params=params_dict_rf,
)
...
# b. Fast Text Trained
rf_fasttxt_optimal, rf_fasttxt_score, rf_fasttxt_params = tune_model(
    RandomForestClassifier(),
    (ft_train_data, train_data.sentiment),
    search_params=params_dict_rf,
)
...
# c. Fast Text (Wiki)
rf_fasttxt_wiki_optimal, rf_fasttxt_wiki_score, rf_fasttxt_wiki_params = tune_model(
    RandomForestClassifier(),
    (ft_wiki_train_data, train_data.sentiment),
    search_params=params_dict_rf,
)
...
rf_w2v_tfidf_clf_optimal, rf_w2v_tfidf_score, rf_w2v_tfidf_params = tune_model(
    RandomForestClassifier(),
    (w2v_tfidf_train_data, train_data.sentiment),
    search_params=params_dict_rf,
)
...
rf_ft_tfidf_clf_optimal, rf_ft_tfidf_score, rf_ft_tfidf_params = tune_model(
    RandomForestClassifier(),
    (ft_tfidf_train_data, train_data.sentiment),
    search_params=params_dict_rf,
)
